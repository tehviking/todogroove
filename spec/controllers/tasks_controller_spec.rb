...
describe TasksController do
  ...
  before do
    @user = User.create(:name=>'Bob', :email=>'a@bc.com', :password=>'password', :password_confirmation=>'password', :pos => 0)
    session[:user_id] = valid_attributes[:user_id] = @user.id
  end

  describe "GET index" do
    it "assigns all tasks as @tasks" do
      task = Task.new(:name => "Blah")
      task.save
      get :index
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested task" do
        ...
        Task.any_instance.should_receive(:update_attributes).with({'these' => 'params', 'tags' => []})
